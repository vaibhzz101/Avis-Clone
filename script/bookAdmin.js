...
let carData =  JSON.parse(localStorage.getItem('bookings'))
...
function display(data){
    let a = data.map((ele)=>{
        return `
        <tr>
            <td class='CD'>${ele.name}</td>
            <td class='CD'>${ele.car_model}</td>
            <td class='CD'>${ele.pik_up}</td>
            <td class='CD'>${ele.drop}</td>
            <td class='CD'>${ele.amount}</td>
            <td class='CD'>${ele.date}</td>
        </tr>`
    }).join('')
